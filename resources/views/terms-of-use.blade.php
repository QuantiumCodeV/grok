...
<div class="min-h-screen bg-black p-6 relative overflow-hidden">
    <div class="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-purple-500/20 blur-3xl"></div>
    <div class="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-pink-500/20 blur-3xl"></div>
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-blue-500/10 blur-3xl"></div>
    <div class="relative max-w-4xl mx-auto bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-[0_0_15px_rgba(255,0,255,0.15),0_0_30px_rgba(120,0,255,0.1)] p-8 z-10">
        <div class="absolute inset-0 rounded-3xl shadow-[inset_0_0_2px_#fff,inset_0_0_4px_#fff,0_0_8px_rgba(255,0,255,0.4),0_0_16px_rgba(255,0,255,0.2)] pointer-events-none"></div>
        <h1 class="text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 drop-shadow-[0_0_5px_rgba(255,0,255,0.5)] tracking-wide">Terms of Use</h1>
        <div class="mt-6 h-px w-full bg-gradient-to-r from-transparent via-purple-500/70 to-transparent shadow-[0_0_8px_rgba(210,0,255,0.8)]"></div>
        <div class="mt-6 text-gray-200/90 leading-relaxed">
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">1. Acceptance of Terms</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">2. Use of Service</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">3. Modifications</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">4. Investor Terms for $GROK Coin</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">5. User Conduct and Responsibilities</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">6. Intellectual Property</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">7. Disclaimers and Limitations of Liability</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">8. Indemnification</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">9. Governing Law</h2>
            ...
            <h2 class="mt-6 text-xl font-semibold text-purple-400">10. Contact Information</h2>
            ...
            <p class="mt-6">By using our platform and participating in the $GROK Coin presale, you acknowledge that you have read, understood, and agreed to these Terms of Use.</p>
        </div>
        <div class="mt-8 text-center"><a class="relative inline-block px-6 py-2 text-purple-300 font-medium transition-all duration-300 overflow-hidden rounded-lg group" href="/dashboard"><span class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span><span class="relative group-hover:text-white group-hover:drop-shadow-[0_0_8px_rgba(255,100,255,0.8)] transition-all duration-300">Back to Dashboard</span></a></div>
    </div>
</div>
</body>
</html>
